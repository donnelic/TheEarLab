...
Generated: 2026-05-03 15:21:08 +02:00
...
|---|---|---|---|---:|
| index.html | HTML | Loaded directly | Yes | 672 |
| css/00-theme.css | CSS | Loaded directly | Yes | 236 |
| css/01-base.css | CSS | Loaded directly | Yes | 653 |
...
| css/07-keyboard.css | CSS | Loaded directly | Yes | 479 |
| css/08-sheet-music.css | CSS | Loaded directly | Yes | 185 |
...
| js/core.00-bootstrap.js | JavaScript | Browser runtime module | Yes | 454 |
| js/core.10-constants.js | JavaScript | Browser runtime module | Yes | 346 |
| js/core.20-envelope.js | JavaScript | Browser runtime module | Yes | 80 |
| js/core.30-storage.js | JavaScript | Browser runtime module | Yes | 153 |
...
| js/events.00-settings.js | JavaScript | Browser runtime module | Yes | 699 |
...
| js/game.00-bootstrap.js | JavaScript | Browser runtime module | Yes | 469 |
| js/game.10-chord-targets.js | JavaScript | Browser runtime module | Yes | 683 |
| js/game.20-round-ui.js | JavaScript | Browser runtime module | Yes | 550 |
| js/game.30-round-flow.js | JavaScript | Browser runtime module | Yes | 335 |
...
| js/settings.20-game.js | JavaScript | Browser runtime module | Yes | 335 |
| js/settings.30-panels.js | JavaScript | Browser runtime module | Yes | 300 |
| README.md | Markdown | Human + AI onboarding | Yes | 167 |
...
| PROJECT_MAP.md | Markdown | Generated reference map | Yes | 1550 |
...
## index.html Map
File: index.html (1-672)

### ID Anchors
| ID | Element | Line |
|---|---|---:|
| settings-toggle | <button> | 23 |
| theme-toggle | <button> | 31 |
| home-toggle | <button> | 38 |
| settings-panel | <aside> | 45 |
| options-trigger | <button> | 53 |
| piano-volume | <input> | 67 |
| volume-value | <span> | 68 |
| piano-trigger | <button> | 75 |
| piano-label | <span> | 77 |
| piano-preview-main | <button> | 82 |
| instrument-browser-trigger | <button> | 85 |
| note-length | <input> | 94 |
| length-value | <span> | 95 |
| advanced-trigger | <button> | 98 |
| key-count-down-oct | <button> | 107 |
| key-count-down | <button> | 109 |
| key-count-value | <span> | 110 |
| key-count-up | <button> | 111 |
| key-count-up-oct | <button> | 112 |
| key-count | <input> | 115 |
| start-note-down-oct | <button> | 124 |
| start-note-down | <button> | 126 |
| start-note-value | <span> | 127 |
| start-note-up | <button> | 128 |
| start-note-up-oct | <button> | 129 |
| custom-cursor | <input> | 140 |
| reset-settings | <button> | 150 |
| advanced-panel | <section> | 153 |
| attack-label-value | <span> | 157 |
| attack-time | <input> | 160 |
| attack-ghost | <span> | 161 |
| attack-value | <span> | 163 |
| decay-label-value | <span> | 167 |
| decay-rate | <input> | 170 |
| decay-ghost | <span> | 171 |
| decay-value | <span> | 173 |
| release-label-value | <span> | 177 |
| release-rate | <input> | 180 |
| release-ghost | <span> | 181 |
| release-value | <span> | 183 |
| sustain-label-value | <span> | 187 |
| sustain-length | <input> | 190 |
| sustain-ghost | <span> | 191 |
| sustain-value | <span> | 193 |
| profile-search | <input> | 198 |
| profile-list | <div> | 199 |
| profile-meta | <div> | 200 |
| profile-save | <button> | 202 |
| profile-apply | <button> | 203 |
| test-envelope | <button> | 208 |
| piano-panel | <section> | 215 |
| piano-options | <div> | 217 |
| instrument-browser-panel | <section> | 220 |
| instrument-preset-search | <input> | 224 |
| instrument-preset-list | <div> | 225 |
| instrument-preset-meta | <div> | 226 |
| instrument-preset-apply | <button> | 228 |
| game-settings-modal | <section> | 233 |
| game-settings-backdrop | <button> | 234 |
| game-settings-title | <h4> | 239 |
| game-settings-close | <button> | 241 |
| practice-mode | <select> | 250 |
| game-key-count-down-oct | <button> | 263 |
| game-key-count-down | <button> | 265 |
| game-key-count-value | <span> | 266 |
| game-key-count-up | <button> | 267 |
| game-key-count-up-oct | <button> | 268 |
| sheet-clef-mode | <select> | 280 |
| sheet-accidental-style | <select> | 294 |
| sheet-note-layout | <select> | 304 |
| note-count | <input> | 317 |
| note-count-value | <span> | 318 |
| blind-mode | <input> | 326 |
| training-mode | <select> | 351 |
| chord-difficulty | <select> | 366 |
| chord-tutorial-open-options | <button> | 378 |
| chord-root-hint | <input> | 391 |
| hide-live-preview | <input> | 404 |
| typing-show-typed | <input> | 417 |
| typing-show-piano | <input> | 430 |
| chord-extra-helpers | <input> | 443 |
| primary-action | <button> | 465 |
| play-selected | <button> | 466 |
| quick-start | <section> | 469 |
| sheet-display | <section> | 522 |
| keyboard | <div> | 525 |
| white-keys | <div> | 526 |
| black-keys | <div> | 527 |
| pedal-icon | <div> | 532 |
| chord-readout | <section> | 537 |
| typing-zone | <section> | 538 |
| chord-answer | <input> | 542 |
| typing-help-toggle | <button> | 543 |
| status-panel | <section> | 549 |
| round-count | <span> | 551 |
| selected-list | <span> | 552 |
| goal-count | <span> | 553 |
| mode-label | <span> | 554 |
| game-settings-open | <button> | 557 |
| hint-button | <button> | 558 |
| result | <div> | 560 |
| helper-slot | <div> | 561 |
| reveal | <div> | 562 |
| hint-flag | <div> | 563 |
| pedal-tip | <span> | 569 |
| chord-tutorial-modal | <section> | 573 |
| chord-tutorial-backdrop | <button> | 574 |
| chord-tutorial-title | <h4> | 577 |
| chord-tutorial-close | <button> | 578 |
| chord-tutorial-step | <div> | 580 |
| chord-tutorial-current | <div> | 582 |
| chord-tutorial-piano | <div> | 585 |
| tutorial-row-root | <div> | 588 |
| chord-tutorial-root-list | <div> | 590 |
| tutorial-row-quality | <div> | 592 |
| chord-tutorial-quality-list | <div> | 594 |
| chord-tutorial-progress | <span> | 600 |
| chord-tutorial-prev | <button> | 602 |
| chord-tutorial-tabs | <div> | 603 |
| chord-tutorial-next | <button> | 605 |
| app-dialog | <section> | 612 |
| app-dialog-backdrop | <button> | 613 |
| app-dialog-title | <h4> | 616 |
| app-dialog-close | <button> | 617 |
| app-dialog-body | <div> | 619 |
| app-dialog-input | <input> | 622 |
| app-dialog-cancel | <button> | 625 |
| app-dialog-confirm | <button> | 626 |

### Script Load Order
| Order | Script | Line |
|---:|---|---:|
| 1 | vendor/libfluidsynth-2.4.6.js?v=20260503151058 | 631 |
| 2 | vendor/js-synthesizer.min.js?v=20260503151058 | 632 |
| 3 | js/core.00-bootstrap.js?v=20260503151058 | 633 |
| 4 | js/core.10-constants.js?v=20260503151058 | 634 |
| 5 | js/core.20-envelope.js?v=20260503151058 | 635 |
| 6 | js/core.30-storage.js?v=20260503151058 | 636 |
| 7 | js/core.40-runtime.js?v=20260503151058 | 637 |
| 8 | js/core.50-soundfonts.js?v=20260503151058 | 638 |
| 9 | js/core.60-keyboard.js?v=20260503151058 | 639 |
| 10 | js/store/reducers.js?v=20260503151058 | 640 |
| 11 | js/store/actions.js?v=20260503151058 | 641 |
| 12 | js/store/selectors.js?v=20260503151058 | 642 |
| 13 | js/store/store.js?v=20260503151058 | 643 |
| 14 | js/features/round/state-mutations.js?v=20260503151058 | 644 |
| 15 | js/features/settings/state-mutations.js?v=20260503151058 | 645 |
| 16 | js/features/chords/index.js?v=20260503151058 | 646 |
| 17 | js/features/typing/index.js?v=20260503151058 | 647 |
| 18 | js/features/tutorial/index.js?v=20260503151058 | 648 |
| 19 | js/features/audio-preview/index.js?v=20260503151058 | 649 |
| 20 | js/features/input/index.js?v=20260503151058 | 650 |
| 21 | js/audio.00-bootstrap.js?v=20260503151058 | 651 |
| 22 | js/audio.10-soundfont-catalog.js?v=20260503151058 | 652 |
| 23 | js/audio.20-engine.js?v=20260503151058 | 653 |
| 24 | js/audio.30-playback.js?v=20260503151058 | 654 |
| 25 | js/audio.40-preview.js?v=20260503151058 | 655 |
| 26 | js/game.00-bootstrap.js?v=20260503151058 | 656 |
| 27 | js/features/sheet-display/index.js?v=20260503143727 | 657 |
| 28 | js/game.10-chord-targets.js?v=20260503151058 | 658 |
| 29 | js/game.20-round-ui.js?v=20260503151058 | 659 |
| 30 | js/game.30-round-flow.js?v=20260503151058 | 660 |
| 31 | js/game.40-reveal-submit.js?v=20260503151058 | 661 |
| 32 | js/settings.00-profiles.js?v=20260503151058 | 662 |
| 33 | js/settings.10-dialogs.js?v=20260503151058 | 663 |
| 34 | js/settings.20-game.js?v=20260503151058 | 664 |
| 35 | js/settings.30-panels.js?v=20260503151058 | 665 |
| 36 | js/events.00-settings.js?v=20260503151058 | 666 |
| 37 | js/events.10-tutorial.js?v=20260503151058 | 667 |
| 38 | js/events.20-helper-cursor.js?v=20260503151058 | 668 |
| 39 | js/events.30-bindings.js?v=20260503151058 | 669 |
...
| body | 5-17 |
| body.landing | 19-22 |
| body.runtime-degraded | 24-26 |
| .app | 28-44 |
| .app>section, .app>header, .app>footer | 48-50 |
| .hero | 52-56 |
| .badge | 58-71 |
| h1 | 73-77 |
| .hero p | 79-85 |
| body:not(.landing) .hero h1, body:not(.landing) .hero p | 88-90 |
| body:not(.landing) .tips | 92-94 |
| .hero, .actions, .quick-start, .game-stack, .tips | 100-103 |
| body:not(.landing) .hero | 105-109 |
| .control | 111-117 |
| .control.compact | 119-121 |
| .control.compact>label | 123-125 |
| .control.compact .control-row | 127-129 |
| .control>label | 131-138 |
| .control-row | 140-144 |
| .control-row.toggle-row | 146-149 |
| .control-row.toggle-row .switch | 151-153 |
| .control-row.toggle-row .unit | 155-157 |
| .control-row.align-end | 159-162 |
| .start-note-row | 164-166 |
| .start-note-stepper | 168-178 |
| .range-hidden | 180-182 |
| .start-note-value | 184-190 |
| .step-btn | 192-204 |
| .step-btn.oct | 206-212 |
| .step-btn:hover | 214-217 |
| .advanced-test | 219-222 |
| .advanced-test .unit | 224-227 |
| input[type="number"] | 229-238 |
| .segmented | 240-244 |
| .segmented-btn | 246-255 |
| .segmented-btn.active | 257-261 |
| .actions | 263-269 |
| .quick-start | 271-278 |
| .quick-mode-btn | 280-306 |
| .quick-mode-btn::before | 308-316 |
| .quick-mode-copy | 318-326 |
| .quick-mode-btn:hover, .quick-mode-btn:focus-visible | 329-334 |
| .quick-mode-title | 336-342 |
| .quick-mode-sub | 344-349 |
| .quick-mode-preview | 351-365 |
| .quick-mode-preview::before | 367-374 |
| .preview-floor | 376-390 |
| .preview-chip | 392-404 |
| .quick-mode-preview-random .preview-chip-a | 406-410 |
| .quick-mode-preview-random .preview-chip-b | 412-417 |
| .quick-mode-preview-random .preview-chip-c | 419-424 |
| .quick-mode-preview-harmonic .preview-chip | 426-428 |
| .quick-mode-preview-harmonic .preview-chip-a | 430-434 |
| .quick-mode-preview-harmonic .preview-chip-b | 436-441 |
| .quick-mode-preview-harmonic .preview-chip-c | 443-447 |
| .quick-mode-preview-chord .preview-chip | 449-452 |
| .quick-mode-preview-chord .preview-chip-a | 454-458 |
| .quick-mode-preview-chord .preview-chip-b | 460-464 |
| .quick-mode-preview-chord .preview-chip-c | 466-471 |
| .quick-mode-preview-sheet .preview-staff | 473-487 |
| .quick-mode-preview-sheet .preview-note | 489-496 |
| .quick-mode-preview-sheet .preview-note::before | 498-509 |
| .quick-mode-preview-sheet .preview-note-a | 511-514 |
| .quick-mode-preview-sheet .preview-note-b | 516-519 |
| .quick-mode-preview-sheet .preview-note-c | 521-524 |
| body:not(.landing) .quick-start | 526-528 |
| .runtime-banner | 530-538 |
| .runtime-banner__body | 540-552 |
| .runtime-banner__title | 554-558 |
| .runtime-banner__summary | 560-564 |
| .runtime-banner__list | 566-573 |
| .runtime-banner__list strong | 575-577 |
| .btn | 579-586 |
| .btn:focus-visible | 588-591 |
| .btn.primary | 593-597 |
| .btn.secondary | 599-603 |
| .btn.ghost | 605-609 |
| .btn.submit | 611-615 |
| .btn:hover | 617-619 |
| body[data-reduced-motion="true"] | 621-629 |
| @keyframes app-pulse | 631-644 |
| .pulse-once | 646-649 |
| body[data-reduced-motion="true"] .pulse-once | 651-653 |
...
### css/07-keyboard.css
File: css/07-keyboard.css (1-479)

#### Top-Level CSS Blocks
| Selector | Lines |
|---|---|
| .keyboard-zone | 1-13 |
| .keyboard-stack | 15-25 |
| .keyboard-wrapper | 27-36 |
| .keyboard | 38-45 |
| .keyboard-wrapper.ends-black | 47-49 |
| .white-keys | 51-54 |
| .black-keys | 56-63 |
| .key | 65-76 |
| .key.white | 78-85 |
| .key.white.has-black | 87-89 |
| .key.black | 91-100 |
| .key span | 102-106 |
| .key.black span | 108-112 |
| .key.active | 114-117 |
| .key.black.active | 119-122 |
| .key.selected | 124-128 |
| .key.typed-preview | 130-132 |
| .key.correct | 134-138 |
| .key.wrong | 140-144 |
| .key.missed | 146-152 |
| .key.black.selected, .key.black.correct, .key.black.wrong | 156-158 |
| .key.black.missed | 160-166 |
| .keyboard.disabled | 168-174 |
| body.tutorial-open .keyboard | 176-178 |
| body.tutorial-open .keyboard.disabled | 180-183 |
| .keyboard.disabled::before | 185-197 |
| body.tutorial-open .keyboard.disabled::before | 199-201 |
| .keyboard.disabled::after | 203-237 |
| body.tutorial-open .keyboard.disabled::after | 239-241 |
| .tips | 243-252 |
| #pedal-tip[hidden] | 254-256 |
| .pedal-box | 258-272 |
| body.landing .pedal-box | 274-276 |
| .pedal-label | 278-288 |
| .pedal-icon | 290-297 |
| .pedal-icon.active | 299-302 |
| .note-pills | 304-311 |
| .reveal-grid.compact .note-pills | 313-315 |
| .note-pill | 317-323 |
| .reveal-grid.compact .note-pill | 325-328 |
| .note-pill.chord-pill | 330-338 |
| .note-pill.chord-pill .chord-link | 340-342 |
| .note-pill.chord-pill .chord-link-bubble | 344-349 |
| .note-pill.chord-pill:hover .chord-link-bubble | 351-354 |
| .note-pill.good | 356-360 |
| .note-pill.bad | 362-366 |
| .note-pill.missed | 368-372 |
| .note-pill.neutral | 374-378 |
| @media (max-width: 700px) | 380-449 |
| @media (max-height: 820px) | 451-472 |
| @media (max-height: 700px) | 474-479 |

### css/08-sheet-music.css
File: css/08-sheet-music.css (1-185)

#### Top-Level CSS Blocks
| Selector | Lines |
|---|---|
| SHEET MUSIC DISPLAY (css/08-sheet-music.css) =====================================... | 5-15 |
| .sheet-display[hidden] | 17-19 |
| .sheet-notation-stage | 22-32 |
| .sheet-notation-grid | 34-39 |
| .sheet-staff-lines | 42-49 |
| .sheet-measure | 51-57 |
| .sheet-measure::after | 59-68 |
| .sheet-measure-label | 70-78 |
| .sheet-notation-meta | 80-87 |
| .sheet-clef, .sheet-time-signature | 90-96 |
| .sheet-clef | 98-101 |
| .sheet-time-signature | 103-111 |
| .sheet-time-beats, .sheet-time-unit | 114-121 |
| .sheet-note-layer | 123-126 |
| .sheet-note | 128-137 |
| .sheet-note-head | 139-148 |
| .sheet-note-stem | 150-159 |
| .sheet-note-stem.up | 161-165 |
| .sheet-accidental | 167-175 |
| .sheet-ledger-line | 177-185 |

## Documentation + Tooling Maps
### README.md
File: README.md (1-167)
| Heading | Line |
|---|---:|
| TheEarLab | 1 |
| Read First | 5 |
...
| Symbol | Lines |
|---|---|
| getRuntimeMessage | 308-316 |
| ensureRuntimeBanner | 318-340 |
| updateRuntimeBanner | 342-365 |
| reportRuntimeIssue | 367-390 |
| runProtected | 392-399 |
| runProtectedAsync | 401-408 |
| bindRuntimeEvent | 410-420 |
| reportMissingDomRefs | 422-429 |

Event bindings:
| Target | Event | Line |
|---|---|---:|
| window | error | 431 |
| window | unhandledrejection | 439 |
...
| Symbol | Lines |
|---|---|
| normalizePracticeProfile | 157-194 |
| normalizePracticeProfiles | 195-203 |
| isTypingOnlyModeFromState | 207-207 |
| getIsSheetRoundFromState | 211-211 |
| getEffectiveBlindModeFromState | 212-212 |
| getEffectivePracticeModeFromState | 213-224 |
| capturePracticeProfileFromState | 225-257 |
...
| shouldRestartRoundForSetting | 43-46 |
| patchSettingsState | 48-54 |
| adjustKeyCount | 478-481 |
| bindKeyCountStepper | 483-488 |
...
| Symbol | Lines |
|---|---|
| getHelperPinRound | 179-179 |
| syncHelperPinRound | 181-187 |
| getLocalPinnedHelperLabels | 189-192 |
| getGlobalPinnedHelperLabels | 194-194 |
| isHelperPinnedGlobalLabel | 196-200 |
| isHelperPinnedLocalLabel | 202-202 |
| toggleHelperPinnedLocalLabel | 208-218 |
| toggleHelperPinnedGlobalLabel | 220-231 |
| setHelperPinnedGlobalLabel | 233-251 |
| setRootHelperPinned | 253-257 |
| getHelperPinFlags | 259-267 |
| applyRoundStatePatch | 273-282 |
| applySubmissionStatePatch | 284-293 |
| normalizeQualityToken | 303-314 |
| renderChordLink | 323-347 |
| isTypingEnabled | 373-373 |
| isTypingOnlyMode | 374-374 |
| getIsChordRound | 375-375 |
| getIsSheetRound | 376-376 |
| getEffectiveBlindMode | 377-377 |
| getKeyboardZoneEl | 378-378 |
| normalizePitchClass | 379-379 |
| getRootName | 380-380 |
| getMidiFromNoteId | 381-381 |
| buildChordLabel | 382-382 |
| getSheetClefLabel | 383-383 |
| getPitchClassSetFromNoteIds | 391-399 |
| getRootGuideNoteId | 405-420 |
| getEffectiveKeyboardSelection | 422-434 |
| getChordDifficultyId | 436-441 |
| getChordDisplayLabel | 443-443 |
| getChordQualityDisplaySuffix | 445-445 |
| getChordDifficultyConfig | 447-450 |
| getAllowedChordQualities | 452-457 |
| getChordQualityHint | 459-462 |
...
| getSheetClefMode | 143-146 |
| chooseSheetClef | 148-154 |
| getSheetPlayableRange | 156-179 |
| getNotesInSheetPlayableRange | 181-185 |
| getClefPools | 187-193 |
| resolveSheetTargetForClef | 195-226 |
| createSheetTarget | 228-298 |
| getNiceTarget | 304-341 |
| getQualityPitchClassSet | 343-349 |
| resolveQualityFromToken | 351-356 |
| parseBassToken | 358-372 |
| splitQualityAndBass | 374-394 |
| buildChordLabelWithBass | 396-402 |
| parseChordInput | 404-441 |
| detectChordFromNoteIds | 443-479 |
| normalizeIntervals | 481-483 |
| fitIntervalsToAvailableRange | 485-505 |
| buildVoicedIntervals | 507-535 |
| chooseRootCandidatesForIntervals | 537-546 |
| buildChordFromRoot | 548-576 |
| createChordTarget | 578-631 |
| createNoteTarget | 633-669 |
| createTarget | 671-682 |
...
| updateModeVisibility | 184-206 |
| updatePrimaryAction | 209-214 |
| updateReplayAvailability | 216-223 |
| getChordHelperHints | 225-241 |
| createDeterministicHelperMask | 259-287 |
| renderChordHelperBox | 289-319 |
| updateStatus | 321-453 |
| updateKeyStates | 455-516 |
| setKeyboardEnabled | 518-521 |
| updateKeyboardScale | 523-534 |
| lockKeyboardForPlayback | 536-549 |
...
| ensureRound | 178-187 |
| playTarget | 189-203 |
| startManualNote | 205-223 |
| releaseManualNote | 225-233 |
| releasePedalNotes | 235-245 |
| startPedalHold | 247-253 |
| stopPedalHold | 255-262 |
| toggleSelection | 264-308 |
| isSelectionCorrect | 310-327 |
| getPlaybackSpan | 329-334 |
...
| refreshOptionsModeVisibility | 89-121 |
| setPracticeMode | 123-224 |
| applyUiFromState | 226-295 |
| commitCriticalChange | 302-307 |
| commitNoteCountChange | 309-318 |
| handleCriticalSettingChange | 320-334 |
